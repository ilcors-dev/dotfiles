...
```bash
stow -vv -t ~ nvim zsh ghostty starship lazygit android-emulator executables opencode git
```
...
```bash
stow -vv -t ~ -D nvim zsh ghostty starship lazygit android-emulator executables opencode git
